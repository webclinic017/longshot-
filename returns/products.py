...
class Products(object):
    ...
    def spy_bench(self,bench,time_horizon_class):
        ...
        bench_returns[f"bench_return"] = (bench_returns["adjclose"] - bench_returns["adjclose"].shift(time_horizon_class.window)) / bench_returns["adjclose"].shift(time_horizon_class.window)
